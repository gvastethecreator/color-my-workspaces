...
- Project number: `22`
- Project title: `Color My Workspaces`
- Project URL: https://github.com/users/gvastethecreator/projects/22
- Local root: `.scratch/vscode-color-my-workspaces/`
...
- Spec: `.scratch/vscode-color-my-workspaces/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-color-my-workspaces/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-color-my-workspaces/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/22
...
5. Add the Issue to Project `22` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-color-my-workspaces --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 22 --owner gvastethecreator --format json
gh project field-list 22 --owner gvastethecreator --format json
gh project item-list 22 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 22 --owner gvastethecreator --url <issue-url>
gh project item-edit 22 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-color-my-workspaces --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-color-my-workspaces --parent <parent-number> --add-blocked-by <number>
```
